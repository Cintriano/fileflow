...
O programa renomeia os arquivos seguindo um padrão baseado nos metadados disponíveis. Há três cenários possíveis:

### ✅ Melhor Caso

Quando as fotos vêm diretamente da minha câmera **Canon T5i** ou do meu celular **Galaxy S23 Ultra**, todos os metadados estão preservados (como data, hora e dispositivo), permitindo uma renomeação precisa
